        ...
        */
        window.onload=function () {
            document.getElementById("form").onsubmit=function () {
                return checkUsername()&&checkStunum()&&checkAge()&&checkEmail()&&checkQq()&&checkLoginname()&&checkPassword();
            }
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/addUserServlet" method="post" id="form">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="xuhao" id="xuhao" value="<%=(int)(Math.random()*10+1)%>"/>
        ...
        <div class="form-group" style="text-align: center">
            ...
            <input class="btn btn-warning" type="button" id="btnReturn" value="返回" />
        </div>
    </form>
</div>
</body>
