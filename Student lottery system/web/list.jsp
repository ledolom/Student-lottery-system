<%@ page import="cn.itcast.day46.demo01.domain.User" %>
<%@ page import="cn.itcast.day46.demo01.domain.PageBean" %>
    ...
    <script>
        ...
        window.onload=function () {
            ...
            function is() {
                ...
                if (nums[${user.xuhao}]){
                    alert("请修改"+"${user.name}"+"的序号，该学生的序号与之前的重复");
                    return true;
                }
                nums[${user.xuhao}]=true;
                </c:forEach>
                return false;
            }
            $("#btn_chouqian").click(function () {
                is();
            });
...
<div class="container">
    ...
    <div style="float: right;margin: 5px">
        ...
        <a class="btn btn-warning" id="btn_chouqian">抽签校验</a>
    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${pb.list}" var="user" varStatus="s">
            ...
            <tr id="row">
                ...
                <td>${user.email}</td>
                <td>${user.xuhao}</td>
                <td><a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/adfindUserServlet?id=${user.id}">修改</a>&nbsp;<a class="btn btn-default btn-sm" href="javascript:deleteUser(${user.id});">删除</a></td>
            </tr>
        </c:forEach>
    </table>
    </form>
